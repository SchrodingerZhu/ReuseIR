...
func.func @bar(%arg0: !reuse_ir.rc<i64, atomic: true, frozen: true>) {
    // CHECK: %[[REG0:[a-z0-9]+]] = llvm.getelementptr %{{[a-z0-9]+}}[0] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(i64, ptr, ptr, i64)>
    // CHECK: %[[REG1:[a-z0-9]+]] = llvm.mlir.constant(4 : i64) : i64
    // CHECK: llvm.atomicrmw add %[[REG0]], %[[REG1]] seq_cst : !llvm.ptr, i64
